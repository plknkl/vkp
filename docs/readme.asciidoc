...
== Description
This API serves as a database crud interface, which accepts GraphQL queries.
...
[source,javascript]
./src/schema/operation.js
----
include::./src/schema/operation.js[]
----
...
[source,javascript]
./src/schema/article.js
----
include::./src/schema/article.js[]
----
